...
<html lang="en">
  ...
  <body>
	<div class="panel panel-default">
	    <div class="panel-heading"><div class="text-center"><h3> DATA PRODUK </h3></div></div>
	    <div class="panel-body">
			...
			<div class="row">
		    <div class="col-lg-4">
			<form class="form-horizontal" action="<?php echo site_url('barang/simpan_data'); ?>" method="post" enctype="multipart/form-data">
				...
				<div class="form-group">
					<label class="control-label col-sm-2" for="total">jumlah</label>
					<div class="col-sm-10">
